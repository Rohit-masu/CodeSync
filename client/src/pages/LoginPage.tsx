            ...
            <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl items-center gap-6 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(57,224,121,0.18),_transparent_35%),linear-gradient(135deg,_rgba(255,255,255,0.03),_rgba(255,255,255,0.01))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10">
                    ...
                    <div className="mt-8">
                        ...
                        <p className="mt-6 text-xs uppercase tracking-[0.18em] text-primary">Sign in to CodeSync</p>
                        <h1 className="mt-3 max-w-md text-3xl font-semibold leading-tight sm:text-4xl">
                            Step back into your room with chat, files, and live collaboration ready.
                        </h1>
                        <p className="mt-4 max-w-lg text-sm leading-6 text-gray-300">
                            Use your account to create a fresh room, rejoin your team, or continue the editor session from where you left it.
                        </p>
                        <div className="mt-8 grid gap-3 sm:grid-cols-2">
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                                <p className="text-xs uppercase tracking-[0.16em] text-gray-500">Fast re-entry</p>
                                <p className="mt-2 text-sm text-gray-200">Join rooms with approvals, files, and chat already in place.</p>
                            </div>
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                                <p className="text-xs uppercase tracking-[0.16em] text-gray-500">Google ready</p>
                                <p className="mt-2 text-sm text-gray-200">Use email login now and keep OAuth ready for demo mode.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(61,64,74,0.98),rgba(33,36,41,0.96))] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:p-8">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Sign in to create rooms, invite teammates, and continue coding.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
                        ...
                        <div className="mt-1 flex items-center justify-between">
                            <label className="flex cursor-pointer items-center gap-2">
                                <input
                                    type="checkbox"
                                    className="h-4 w-4 rounded border-gray-600 bg-dark text-primary focus:ring-primary focus:ring-offset-dark"
                                />
                                <span className="text-sm text-gray-400">Remember me</span>
                            </label>
                            <button
                                type="button"
                                onClick={() => toast("Forgot password flow to be implemented!")}
